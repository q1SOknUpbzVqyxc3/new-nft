import { BadgeCheck, Camera, KeyRound, Settings, UserRound } from "lucide-react";
...
type Section = "general" | "security" | "settings";
...
export function ProfilePage({ section = "general" }: { section?: Section }) {
  ...
  return (
    <main className="container page">
      <header className="page-header"><div><span className="eyebrow">Account</span><h1>Профиль</h1><p>{user.email} · аккаунт с {formatDateTime(user.created)}</p></div></header>
